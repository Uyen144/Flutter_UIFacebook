...
import 'package:flutter_facebook_clone1/widgets/create_post_container.dart';
import 'package:flutter_facebook_clone1/widgets/stories.dart';
  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      ...
      slivers: [
        ...
        SliverToBoxAdapter(
          child: CreataPostContainer(currentUser: currentUser),
        ),
        SliverPadding(
